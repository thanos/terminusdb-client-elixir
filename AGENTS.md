...
| v0.3.3 | Bug fixes: document query filtering, branch-scoped document/schema paths, Schema.all @context filtering, Livebook script repair, regression tests | **Done** |
